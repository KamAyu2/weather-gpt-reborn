...
const HI: Record<string, string> = {
  ...
  "suggestion.historical": "पिछले महीने दिल्ली का मौसम कैसा था?",
  "suggestion.nwp": "मुंबई का GFS पूर्वानुमान",
  "suggestion.climate": "पिछले साल चेन्नई का जलवायु रुझान",
  "mobile.home": "होम",
...
const GU: Record<string, string> = {
  ...
  "suggestion.historical": "ગત મહિને દિલ્હીમાં હવામાન કેવું હતું?",
  "suggestion.nwp": "મુંબઈ GFS આગાહી",
  "suggestion.climate": "ગત વર્ષે ચેન્નઈનું હવામાન વલણ", "mobile.home": "હોમ", "mobile.compare": "તુલના", "mobile.saved": "સાચવ્યું", "common.loading": "લોડ થઈ રહ્યું છે…", "common.error": "કંઈક ખોટું થયું", "common.retry": "ફરી પ્રયાસ કરો", "common.save": "સાચવો", "common.cancel": "રદ કરો", "common.delete": "કાઢી નાખો", "common.close": "બંધ કરો", "common.refresh": "રિફ્રેશ", "common.saved": "સાચવેલા સંદેશા", "common.noSavedMessages": "હજુ કોઈ સાચવેલા સંદેશા નથી.", "common.starToSave": "અહીં સાચવવા માટે કોઈ પણ હવામાન જવાબને સ્ટાર કરો.", "common.weatherByOpenMeteo": "હવામાન ડેટા Open-Meteo દ્વારા", "common.removeFromSaved": "સાચવેલામાંથી દૂર કરો", "common.saveThisMessage": "આ સંદેશ સાચવો",
  "suggestion.village": "પંજાબમાં મારા ગામનું હવામાન",
  "suggestion.irrigate": "પુણેમાં પાકને સિંચન કરવું જોઈએ?",
  "suggestion.cyclone": "ચેન્નઈમાં વાવાઝોડાની ચેતવણી?",
  "suggestion.uv": "આજે શિમલામાં UV ઇન્ડેક્સ",
  "suggestion.chai": "હું ચા કેવી રીતે બનાવું?",
  "suggestion.srinagar": "આ અઠવાડિયે શ્રીનગરનું હવામાન",
  "weather.feelsLike": "અનુભવ",
  "dashboard.clickToLoad": "લાઈવ હવામાન લોડ કરવા ક્લિક કરો",
  "agri.heatStress": "પાક માટે ગરમી તાણનો ભય",
  "agri.delayPesticide": "કીટકનાશક/ખાતર ઉપયોગ મોકૂફ રાખો — વરસાદની સંભાવના",
  "agri.highHumidity": "વધુ ભેજ — પાકમાં ફૂગ રોગો પર નજર રાખો",
  "agri.strongWinds": "મજબૂત પવનો — સ્પ્રે ઝુંબેશથી બચો",
  "agri.goodConditions": "કૃષિ પ્રવૃત્તિઓ માટે સારી સ્થિતિ",
  "disaster.flood": "પૂર ચેતવણી",
  "disaster.cyclone": "વાવાઝોડું ચેતવણી",
  "disaster.heatwave": "ગરમીની લહેર ચેતવણી",
  "disaster.coldwave": "થંડી લહેર ચેતવણી",
  "common.compareHint": "4 શહેરો માટે સાઈડ-બાય-સાઈડ હવામાન તુલના.",
};
...
const KN: Record<string, string> = {
  ...
  "suggestion.historical": "ಕಳಿದ ತಿಂಗಳು ದೆಹಲಿಯಲ್ಲಿ ಹವಾಮಾನ ಹೇಗಿತ್ತು?",
  "suggestion.nwp": "ಬೆಂಗಳೂರು GFS ಮುನ್ಸೂಚನೆ",
  "suggestion.climate": "ಕಳಿದ ವರ್ಷ ಚೆನ್ನೈ ಹವಾಮಾನ ಪ್ರವೃತ್ತಿ", "mobile.home": "ಹೋಮ್", "mobile.compare": "ಹೋಲಿಸಿ", "mobile.saved": "ಉಳಿಸಿದ", "common.loading": "ಲೋಡ್ ಆಗುತ್ತಿದೆ…", "common.error": "ಏನೋ ತಪ್ಪಾಗಿದೆ", "common.retry": "ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ", "common.save": "ಉಳಿಸಿ", "common.cancel": "ರದ್ದು", "common.delete": "ಅಳಿಸಿ", "common.close": "ಮುಚ್ಚಿ", "common.refresh": "ರಿಫ್ರೆಶ್", "common.saved": "ಉಳಿಸಿದ ಸಂದೇಶಗಳು", "common.noSavedMessages": "ಇನ್ನೂ ಉಳಿಸಿದ ಸಂದೇಶಗಳಿಲ್ಲ.", "common.starToSave": "ಇದನ್ನು ಇಲ್ಲಿ ಉಳಿಸಲು ಯಾವುದೇ ಹವಾಮಾನ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಸ್ಟಾರ್ ಮಾಡಿ.", "common.weatherByOpenMeteo": "ಹವಾಮಾನ ಡೇಟಾ Open-Meteo ನಿಂದ", "common.removeFromSaved": "ಉಳಿಸಿದಿಂದ ತೆಗೆದುಹಾಕಿ", "common.saveThisMessage": "ಈ ಸಂದೇಶವನ್ನು ಉಳಿಸಿ",
  "suggestion.village": "ಪಂಜಾಬ್‌ನಲ್ಲಿ ನನ್ನ ಗ್ರಾಮದ ಹವಾಮಾನ",
  "suggestion.irrigate": "ಪುಣೆಯಲ್ಲಿ ಬೆಳೆಗಳಿಗೆ ನೀರಾವರಿ ಮಾಡಬೇಕೇ?",
  "suggestion.cyclone": "ಚೆನ್ನೈನಲ್ಲಿ ಚಂಡಮಾರುತ ಎಚ್ಚರಿಕೆ?",
  "suggestion.uv": "ಇಂದು ಶಿಮ್ಲಾದಲ್ಲಿ UV ಸೂಚ್ಯಾಂಕ",
  "suggestion.chai": "ನಾನು ಹೇಗೆ ಚಹಾ ಮಾಡುವುದು?",
  "suggestion.srinagar": "ಈ ವಾರ ಶ್ರೀನಗರ ಹವಾಮಾನ",
  "weather.feelsLike": "ಅನಿಸುತ್ತಿದೆ",
  "dashboard.clickToLoad": "ಲೈವ್ ಹವಾಮಾನ ಲೋಡ್ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ",
  "agri.heatStress": "ಬೆಳೆಗಳಿಗೆ ಉಷ್ಣ ಒತ್ತಡದ ಅಪಾಯ",
  "agri.delayPesticide": "ಕೀಟನಾಶಕ/ಗೊಬ್ಬರ ಬಳಕೆ ವಿಳಂಬಿಸಿ — ಮಳೆ ಸಾಧ್ಯತೆ",
  "agri.highHumidity": "ಹೆಚ್ಚಿನ ತೇವ — ಬೆಳೆಗಳಲ್ಲಿ ಶಿಲೀಂಧ್ರ ರೋಗಗಳನ್ನು ಗಮನಿಸಿ",
  "agri.strongWinds": "ಬಲವಾದ ಗಾಳಿ — ಸಿಂಪಡಣೆ ಅಭಿಯಾನಗಳನ್ನು ತಪ್ಪಿಸಿ",
  "agri.goodConditions": "ಕೃಷಿ ಚಟುವಟಿಕೆಗಳಿಗೆ ಒಳ್ಳೆಯ ಪರಿಸ್ಥಿತಿಗಳು",
  "disaster.flood": "ಪ್ರವಾಹ ಎಚ್ಚರಿಕೆ",
  "disaster.cyclone": "ಚಂಡಮಾರುತ ಎಚ್ಚರಿಕೆ",
  "disaster.heatwave": "ಉಷ್ಣ ಅಲೆ ಎಚ್ಚರಿಕೆ",
  "disaster.coldwave": "ಚಳಿ ಅಲೆ ಎಚ್ಚರಿಕೆ",
  "common.compareHint": "4 ನಗರಗಳಿಗೆ ಹೋಲಿಕೆ ಹವಾಮಾನ.",
};

const ML: Record<string, string> = {
  "nav.dashboard": "ഡാഷ്‌ബോർഡ്", "nav.newChat": "പുതിയ ചാറ്റ്", "nav.compareCities": "നഗരങ്ങളെ താരതമ്യം ചെയ്യുക", "nav.savedMessages": "സേവ് ചെയ്ത സന്ദേശങ്ങൾ", "nav.darkMode": "ഡാർക്ക് മോഡ്", "nav.lightMode": "ലൈറ്റ് മോഡ്", "nav.signOut": "സൈൻ ഔട്ട്", "nav.chats": "ചാറ്റുകൾ", "dashboard.title": "ഡാഷ്‌ബോർഡ്", "dashboard.subtitle": "കാലാവസ്ഥ ഓവർവ്യൂ നിങ്ങളുടെ സേവ് ചെയ്ത ഇൻസൈറ്റുകൾ.", "dashboard.liveWeather": "ലൈവ് കാലാവസ്ഥ", "dashboard.askQuestion": "ഒരു ചോദ്യം ചോദിക്കൂ", "dashboard.myLocation": "എന്റെ സ്ഥലം", "dashboard.loadingWeather": "കാലാവസ്ഥ ഡേറ്റ ലോഡ് ചെയ്യുന്നു...", "chat.placeholder": "കാലാവസ്ഥയെക്കുറിച്ച് ചോദിക്കൂ…", "chat.welcome": "കാലാവസ്ഥയെക്കുറിച്ച് ചോദിക്കൂ", "chat.welcomeSubtitle": "ലോകത്തെ ഏതൊരു സ്ഥലത്തെയും നിലവിലെ അവസ്ഥ, പ്രവചനം, മുന്നറിയിപ്പുകൾ നേടുക.", "chat.chat": "ചാറ്റ്", "chat.dashboard": "ഡാഷ്‌ബോർഡ്", "compare.title": "നഗരങ്ങളെ താരതമ്യം ചെയ്യുക", "compare.subtitle": "4 നഗരങ്ങൾക്ക് താരതമ്യ കാലാവസ്ഥ.", "weather.current": "ഇപ്പോൾ", "weather.temperature": "താപനില", "weather.humidity": "ആർദ്രത", "weather.wind": "കാറ്റ്", "agri.title": "കൃഷി ഉപദേശം", "disaster.title": "ദുരന്ത മുന്നറിയിപ്പ്", "disaster.allClear": "എല്ലാം വ്യക്തം — ഗുരുതരമായ കാലാവസ്ഥ മുന്നറിയിപ്പുകൾ ഇല്ല", "suggestion.weather": "കൊച്ചിയിൽ കാലാവസ്ഥ എങ്ങനെയുണ്ട്?", "suggestion.forecast": "ഡൽഹി 7 ദിവസ പ്രവചനം", "suggestion.joke": "എനിക്ക് ഒരു തമാശ പറയൂ", "suggestion.capital": "ഫ്രാൻസിന്റെ തലസ്ഥാനം എന്താണ്?",
  "suggestion.historical": "കഴിഞ്ഞ മാസം ഡൽഹിയിൽ കാലാവസ്ഥ എങ്ങനെയായിരുന്നു?",
  "suggestion.nwp": "മുംബൈ GFS പ്രവചനം",
  "suggestion.climate": "കഴിഞ്ഞ വർഷം ചെന്നൈയിലെ കാലാവസ്ഥ പ്രവണത", "mobile.home": "ഹോം", "mobile.compare": "താരതമ്യം", "mobile.saved": "സേവ് ചെയ്തു", "common.loading": "ലോഡ് ചെയ്യുന്നു…", "common.error": "എന്തോ തെറ്റ് സംഭവിച്ചു", "common.retry": "വീണ്ടും ശ്രമിക്കൂ", "common.save": "സേവ്", "common.cancel": "റദ്ദാക്കുക", "common.delete": "ഇല്ലാതാക്കുക", "common.close": "അടയ്ക്കുക", "common.refresh": "റീഫ്രഷ്", "common.saved": "സേവ് ചെയ്ത സന്ദേശങ്ങൾ", "common.noSavedMessages": "ഇതുവരെ സേവ് ചെയ്ത സന്ദേശങ്ങൾ ഇല്ല.", "common.starToSave": "ഇതിങ്ങെ സേവ് ചെയ്യാൻ ഏതെങ്കിലും കാലാവസ്ഥ പ്രതികരണത്തെ സ്റ്റാർ ചെയ്യുക.", "common.weatherByOpenMeteo": "കാലാവസ്ഥ ഡേറ്റ Open-Meteo മൂലം", "common.removeFromSaved": "സേവ് ചെയ്തതിൽ നിന്ന് നീക്കം ചെയ്യുക", "common.saveThisMessage": "ഈ സന്ദേശം സേവ് ചെയ്യുക",
  "suggestion.village": "പഞ്ചാബിലെ എന്റെ ഗ്രാമത്തിലെ കാലാവസ്ഥ",
  "suggestion.irrigate": "പൂനെയിൽ വിളകൾക്ക് ജലസേചനം ചെയ്യണോ?",
  "suggestion.cyclone": "ചെന്നൈയിൽ ചുഴലിക്കാറ്റ് മുന്നറിയിപ്പ്?",
  "suggestion.uv": "ഇന്ന് ഷിംലയിൽ UV സൂചിക",
  "suggestion.chai": "ഞാൻ എങ്ങനെ ചായ ഉണ്ടാക്കും?",
  "suggestion.srinagar": "ഈ ആഴ്ച ശ്രീനഗറിലെ കാലാവസ്ഥ",
  "weather.feelsLike": "അനുഭവപ്പെടുന്നു",
  "dashboard.clickToLoad": "ലൈവ് കാലാവസ്ഥ ലോഡ് ചെയ്യാൻ ക്ലിക്ക് ചെയ്യുക",
  "agri.heatStress": "വിളകൾക്ക് താപ സമ്മർദ്ദ അപകടം",
  "agri.delayPesticide": "കീടനാശിനി/വളം ഉപയോഗം നീട്ടിവയ്ക്കുക — മഴ സാധ്യത",
  "agri.highHumidity": "അധിക ഈർപ്പം — വിളകളിൽ പൂപ്പൽ രോഗങ്ങൾ നിരീക്ഷിക്കുക",
  "agri.strongWinds": "�ക്തമായ കാറ്റ് — സ്പ്രേ പ്രവർത്തനങ്ങൾ ഒഴിവാക്കുക",
  "agri.goodConditions": "കൃഷി പ്രവർത്തനങ്ങൾക്ക് നല്ല അവസ്ഥ",
  "disaster.flood": "വെള്ളപ്പൊക്ക മുന്നറിയിപ്പ്",
  "disaster.cyclone": "ചുഴലിക്കാറ്റ് മുന്നറിയിപ്പ്",
  "disaster.heatwave": "ചൂട് തരംഗ മുന്നറിയിപ്പ്",
  "disaster.coldwave": "തണുപ്പ് തരംഗ മുന്നറിയിപ്പ്",
  "common.compareHint": "4 നഗരങ്ങൾക്ക് താരതമ്യ കാലാവസ്ഥ.",
};
...
const PA: Record<string, string> = {
  ...
  "suggestion.historical": "ਪਿਛਲੇ ਮਹੀਨੇ ਦਿੱਲੀ ਵਿੱਚ ਮੌਸਮ ਕਿਹੋ ਜਿਹਾ ਸੀ?",
  "suggestion.nwp": "ਜਲੰਧਰ ਦਾ GFS ਪੂਰਵ-ਅਨੁਮਾਨ",
  "suggestion.climate": "ਪਿਛਲੇ ਸਾਲ ਚੇਨਨਈ ਦਾ ਮੌਸਮੀ ਰੁਝਾਨ", "mobile.home": "ਹੋਮ", "mobile.compare": "ਤੁਲਨਾ", "mobile.saved": "ਸੰਭਾਲਿਆ", "common.loading": "ਲੋਡ ਹੋ ਰਿਹਾ ਹੈ…", "common.error": "ਕੁਝ ਗਲਤ ਹੋ ਗਿਆ", "common.retry": "ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ", "common.save": "ਸੰਭਾਲੋ", "common.cancel": "ਰੱਦ", "common.delete": "ਮਿਟਾਓ", "common.close": "ਬੰਦ", "common.refresh": "ਰੀਫ੍ਰੈਸ਼", "common.saved": "ਸੰਭਾਲੇ ਸੁਨੇਹੇ", "common.noSavedMessages": "ਅਜੇ ਕੋਈ ਸੰਭਾਲੇ ਸੁਨੇਹੇ ਨਹੀਂ.", "common.starToSave": "ਇਹ ਇੱਥੇ ਸੰਭਾਲਣ ਲਈ ਕਿਸੇ ਵੀ ਮੌਸਮ ਜਵਾਬ ਨੂੰ ਸਟਾਰ ਕਰੋ.", "common.weatherByOpenMeteo": "ਮੌਸਮ ਡੇਟਾ Open-Meteo ਤੋਂ", "common.removeFromSaved": "ਸੰਭਾਲੇ ਵਿੱਚੋਂ ਹਟਾਓ", "common.saveThisMessage": "ਇਹ ਸੁਨੇਹਾ ਸੰਭਾਲੋ",
  "suggestion.village": "ਪੰਜਾਬ ਵਿੱਚ ਮੇਰੇ ਪਿੰਡ ਦਾ ਮੌਸਮ",
  "suggestion.irrigate": "ਪੁਣੇ ਵਿੱਚ ਫ਼ਸਲਾਂ ਨੂੰ ਸਿੰਚਾਈ ਕਰਨੀ ਚਾਹੀਦੀ ਹੈ?",
  "suggestion.cyclone": "ਚੇਨਨਈ ਵਿੱਚ ਚੱਕਰਵਾਤ ਅਲਰਟ?",
  "suggestion.uv": "ਅੱਜ ਸ਼ਿਮਲਾ ਵਿੱਚ UV ਸੂਚਕ",
  "suggestion.chai": "ਮੈਂ ਚਾਹ ਕਿਵੇਂ ਬਣਾਉਂ?",
  "suggestion.srinagar": "ਇਸ ਹਫ਼ਤੇ ਸ਼੍ਰੀਨਗਰ ਦਾ ਮੌਸਮ",
  "weather.feelsLike": "ਲੱਗ ਰਿਹਾ ਹੈ",
  "dashboard.clickToLoad": "ਲਾਈਵ ਮੌਸਮ ਲੋਡ ਕਰਨ ਲਈ ਕਲਿੱਕ ਕਰੋ",
  "agri.heatStress": "ਫ਼ਸਲਾਂ ਲਈ ਗਰਮੀ ਤਣਾਅ ਦਾ ਖ਼ਤਰਾ",
  "agri.delayPesticide": "ਕੀਟਨਾਸ਼ਕ/ਖਾਦ ਵਰਤੋਂ ਲੰਘਾਓ — ਮੀਂਹ ਦੀ ਸੰਭਾਵਨਾ",
  "agri.highHumidity": "ਜ਼ਿਆਦਾ ਨਮੀ — ਫ਼ਸਲਾਂ ਵਿੱਚ ਉੱਲੀ ਦੇ ਰੋਗਾਂ 'ਤੇ ਨਜ਼ਰ ਰੱਖੋ",
  "agri.strongWinds": "ਤੇਜ਼ ਹਵਾਵਾਂ — ਛਿੜਕਾਅ ਮੁਹਿੰਮਾਂ ਤੋਂ ਬਚੋ",
  "agri.goodConditions": "ਖੇਤੀ ਗਤੀਵਿਧੀਆਂ ਲਈ ਵਧੀਆ ਹਾਲਤਾਂ",
  "disaster.flood": "ਹੜ੍ਹ ਚੇਤਾਵਨੀ",
  "disaster.cyclone": "ਚੱਕਰਵਾਤ ਅਲਰਟ",
  "disaster.heatwave": "ਲੂ ਚੇਤਾਵਨੀ",
  "disaster.coldwave": "ਠੰਢ ਲਹਿਰ ਚੇਤਾਵਨੀ",
  "common.compareHint": "4 ਸ਼ਹਿਰਾਂ ਲਈ ਮੁਕਾਬਲਤਨ ਮੌਸਮ।",
};
